            ...
            try {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    ...
                    public void run() {
                        if(num.equals("1"))
                        {
                            Toast.makeText(BarcodeScanActivity.this, "One item is added..Total cost:"+msg, Toast.LENGTH_LONG).show();
                        }
                        else if(num.equals("2"))
                        {
                            Toast.makeText(BarcodeScanActivity.this, "One item is removed..Total cost:"+msg, Toast.LENGTH_LONG).show();
